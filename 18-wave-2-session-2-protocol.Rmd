...
### W2 Protocol – MRI SCREEN

- check if participant needs to complete the mri screen
- read the mri screen to participant like an interview and fill out on REDCap manually
- discuss any concerns relevant to MRI
...
6. Mark off as complete on the Wave 2 data entry sheet of the participant log
