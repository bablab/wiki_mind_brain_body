...
\item
  Do not run session until 100\% certain of eligibility! ( if missing age or some other detail make sure to obtain it and verify eligibility before running session)
\end{itemize}
...
\item
  ...
  \item
    ...
    \end{itemize}
  \item
    \emph{MBBXXX WX- Home Session Reminder 2 (call)} - 17 days after Session 2
    ...
    \item
      Add \emph{Status: Incomplete} to the description
    \item
      Add \emph{" only if missing package and have not been able to reach participant about it" } to description
    \end{itemize}
  \end{itemize}
\end{itemize}
...
\item
  ...
  \item
    If package still missing at point of home session reminder 2 email:

    \begin{itemize}
    \tightlist
    \item
      sent a message in SRA chat that we haven't received MBBXXX package
      ...
      \end{itemize}
    \item
      make home session call 2 three days after email and check in
    \item
      important part is making sure we know what packages are missing and that they've exhausted the home session reminders
    \end{itemize}
  \end{itemize}
\end{itemize}
...
\item
  ...
  \item
    Change REDCap SMBB wave 1 status from enrolled to default dashboard ( blank choice)
  \item
    Make a note that they were a no-show and we're following no show steps
  \item
...
\emph{I am going to turn off my camera and mute myself to be out of the recording, and I will also step out of the room and will not be listening in. Please have any other children leave the room if possible. As a reminder make sure you are both visible on the screen and that you speak loud enough for your mic to pick up on it. I will come back in and let you know when the six minutes are all done!}
...
\tightlist
\item
  Refer to the short hair packaging instructions. \url{https://app.box.com/file/755295304996}
\item
...
\item
  ...
  \tightlist
  \item
    will also send gift card code in payment email as well as sending physical card in mail
  \end{itemize}
\item
