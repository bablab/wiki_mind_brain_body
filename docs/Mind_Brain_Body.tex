...
\citep{repetti_2002}, and parent-related early adversities (e.g., abuse and
neglect) contribute to more than a third of mental illnesses {[}anxiety
being the most common diagnosis; \citet{kessler_2005}{]}. Clinical,
...
\citep{bailey_1999, bailey_2010, omahony_2009} and that microbial
populations are causally related to the expression of anxious behaviors
\citep{collins_2013}. In humans too, microbiome-related gastrointestinal
disturbances (e.g., irritable bowel syndrome) and anxiety are highly
comorbid \citep{kennedy_2014, callaghan_2019}. In terms of the memory
system, rodent studies show that typically weak memories in childhood
get stronger following adversity {[}\citet{callaghan_2012a}; callaghan\_2012b;
\citet{cowan_2013}{]}, and exposure to early stress promotes hippocampal synaptic
development \citep{huang_2005}, which aids long-term memory persistence.
...
threat\citep{acheson_2012, zlomuzica_2014}, and hippocampal dysfunction is
common in anxiety disorders \citep{godsil_2013}. Importantly, hippocampal
development is causally tied to the microbiome in early life
\citep{callaghan_2016, clarke_2013, cowan_2016, gareau_2011}, suggesting
...
using the Family Interaction Macrocoding System (FIMS)\citep{holmbeck_1995}.
...
\item
  ...
  Schedule (FIMS)\citep{holmbeck_1995}.
\item
  ...
  \item
    ...
    future (but likely not needing further training)\citep{holbein_2014}.
  \item
    ...
    and convinced me that we should use the FIMS \citep{richmond_2018}
  \end{itemize}
\end{itemize}
...
\emph{Note: Be careful using physiology during the recall phase, as the
...
\citep{brunec_2018, lambert_2019, tambini_2010}.
...
\tightlist
\item
  \citet{tambini_2010} - enhanced brain correlations at rest are associated
...
\item
  \citet{brunec_2018} - Multiple scales of representation along the
  ...
  project.
\item
  Results of the K99 project - in the K99, across typical development,
  ...
  adolescence.
\item
  \citet{lambert_2019} - altered development of hippocampus dependent
...
Task based on original task by \citet{frank_2004}, re-programmed and adapted by
...
\tightlist
\item
  The first is to simply look at threat learning and extinction in
  ...
  extinguishing.
\item
  The second purpose of the task is to look at how conditioning and
...
Past literature: This paper by \citet{shalev_2018} demonstrates the effect we
...
\citet{staufenbiel_2013}{]}. Hair samples will never be used for genetic
analysis.
...
inter-assay coefficients of variation for this assay are both \textless10\%
...
week (\href{https://www.frontiersin.org/articles/10.3389/fimmu.2021.795580/full\#B29}{Brindle et al.,
2019}).
...
flexibility in the collection of samples in field settings (\href{https://pubmed.ncbi.nlm.nih.gov/18232218/}{McDade et
al., 2007}). That is why our
...
\href{https://ucla.app.box.com/file/748332038901}{product\_change\_notification}

\hypertarget{microbiome-sequencing}{%
\subsubsection{Microbiome Sequencing}\label{microbiome-sequencing}}

Work was performed at the OKED Genomics Core at Arizona State University.

• Caporaso, J. G., Lauber, C. L., Walters, W. A., Berg-Lyons, D., Lozupone, C. A., Turnbaugh, P. J., Noah Fierer, N., \& Knight, R. (2011). Global patterns of 16S rRNA diversity at a depth of millions of sequences per sample. Proc Natl Acad Sci USA 108, 4516--4522. \url{http://doi.org/10.1073/pnas.1000080107}

\textbf{DNA extraction:} Microbial DNA extraction was extracted from samples
by using DNeasy PowerSoil Kit -- (QIAGEN) following directions of the
manufacturer.

\textbf{Microbiome library preparation methodology:} Bacterial community
...
(EMP) (\url{http://www.earthmicrobiome.org/emp-standard-protocols/}) for the
...
\textbf{Metagenomics Library Preparation methodology:} Illumina compatible
...
\midrule()
\endhead
Beck Depression Inventory -- II (bdi\_ii) & Mental health/affective functioning. Developed for the assessment of symptoms corresponding to criteria for diagnosing depressive disorders listed in the DSM IV. & (Beck, Steer, \& Brown, 1996) & Parents (self report) & Wave 1, Wave 1 Online & \\
COVID-19 Objective Questionnaire (covid\_objective) & COVID-19 objective measures. This questionnaire consists of 12 items to identify health changes and lifestyle changes made From the impacts of the COVID-19 outbreak. & (Made by BABLab) & Parents (self report) & Wave 1 Online & \\
...
Pediatric Quality of Life - Gastrointestinal (pedsql\_gi) & Physical symptoms. The PedsQL Gastrointestinal Symptoms Scale will be administered. These questionnaires are designed to assess the incidence of gastrointestinal symptoms in youth. & (Varni et al., 2015) & Parents (proxy) & Wave 1, Wave 1 Online & \\
Pediatric Quality of Life - Well Being (pedsql\_wb) & Physical symptoms. The PedsQL General Wellbeing Scale will be administered. These questionnaires are designed to assess general feelings of wellbeing in youth. & (Varni et al., 2015) & Parents (proxy) & Wave 1, Wave 1 Online & \\
Pediatric Quality of Life (pedsql\_f) & Physical symptoms. The PedsQL Multidimensional Fatigue Scale will be administered. These questionnaires are designed to assess the incidence of fatigue symptoms in youth. & (Varni et al., 2015) & Parents (proxy) & Wave 1, Wave 1 Online & \\
...
Child Somatization Symptom Inventory (cssi) & The CSSI assesses a variety of nonspecific somatic symptoms. & (Walker et al., 2009) & Parents (proxy){[}children \textless{} 8 years{]} & Wave 1, Wave 1 Online & \\
...
COVID-19 Objective Questionnaire (covid\_objective) & COVID-19 objective measures. This questionnaire consists of 12 items to identify health changes and lifestyle changes made From the impacts of the COVID-19 outbreak. & (Made by BABLab) & Parents (proxy) & Wave 1 online & \\
Parenting Stress (parenting\_stress) & Designed to evaluate the magnitude of stress in the parent-child system, focusing on three major domains of stress: 1) child/adolescent characteristics, 2) parent characteristics, and 3) situational/demographic life stress. Revised questionnaire focuses on stress in the context of COVID-19. & (Made by BABLab) & Parents (proxy) & Wave 1 online & \\
\bottomrule()
\end{longtable}

\hypertarget{fci-and-iai-data-consolidation}{%
\paragraph{FCI and IAI Data Consolidation}\label{fci-and-iai-data-consolidation}}

The Foster Care Inventory (FCI) and International Adoption Inventory (IAI) were collected from caregivers at Wave 1, and recollected at Wave 2 for those who didn't complete them during W1. Additionally, a shorter version of the FCI/IAI with additional explanations and visual examples (called ``fci\_3questions'') was administered at Wave 3, due to concerns that caregivers weren't understanding the questions on the FCI/IAI. After W3 data collection was complete, Fran consolidated the FCI/IAI data for each participant across the study: for those who provided the data at multiple waves, if there was a discrepancy in age left bio family, age entered stable care, or number of transitions, Fran used the number of transitions datapoints from the fci\_3questions at W3 and picked one of the data points for age left bio care and age entered stable care based on which one made the most sense (e.g., if the caregiver said the child was 3.5 years old when they left bio care and 3.5 years old when they entered stable care at W1, but reported 5 caregiving transitions at W3, then I took the W3 datapoints for age left bio care and age entered stable care). Note: Fran's impression when consolidating the data is that there is less uncertainty within the final number of transitions variable compared to the age left bio care and age entered stable care, so Fran recommends using the number of tranisitions viariable. The final consolidated data (fci\_consolidated\_final.csv) can be found in the Scripts folder in subfolder: ``FCI\_W1\_W3\_Consolidation''.
...
\midrule()
\endhead
COVID-19 Written Response (written\_response\_parentself) & (Pennebaker, 1997) & Parents (self report) & Wave 1 Online {[}optional{]} & \\
\bottomrule()
\end{longtable}
...
\midrule()
\endhead
COVID-19 Written Response (written\_response) & (Pennebaker, 1997) & Children (self report) & Wave 1 Online {[}optional{]} & \\
\bottomrule()
\end{longtable}
...
\begin{figure}
\centering
\includegraphics{images/audits/1.png}
\caption{}
\end{figure}
...
\begin{figure}
\centering
\includegraphics{images/audits/3.png}
\caption{}
\end{figure}
...
\begin{figure}
\centering
\includegraphics{images/audits/4.png}
\caption{}
\end{figure}
...
\begin{figure}
\centering
\includegraphics{images/audits/5.png}
\caption{}
\end{figure}
...
\hypertarget{hair-length-2}{%
\subsubsection{Hair Length}\label{hair-length-2}}
...
\begin{figure}
\centering
\includegraphics{images/troubleshooting/1.png}
\caption{}
\end{figure}
