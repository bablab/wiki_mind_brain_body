...
\item
  Send \emph{Session 2 TO DO List} email
\end{itemize}
...
\item
  Open the correct training file for the participant, and delete the rows for all participants except the participant in question.
\item
  Save the file in the participants Box folder as ``MBBXXX\_halloween\_training.csv''
\item
  Open the correct test file for the participant, and delete the rows for all participants except the participant in question.
\item
