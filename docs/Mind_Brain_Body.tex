...
\chapter{Child/Teen \& Parent General Protocols}\label{childteen-parent-general-protocols}}

\hypertarget{consent-assent}{%
\section{Consent \& Assent}\label{consent-assent}}
...
\section{Parent/Child Observation}\label{parentchild-observation}}
...
\subsection{Coding the Interview}\label{coding-the-interview}}
...
\chapter{Child/Teen Protocols}\label{childteen-protocols}}

\hypertarget{biopac-electrode-hookup}{%
\section{BioPac Electrode Hookup}\label{biopac-electrode-hookup}}

\hypertarget{electrode-placementpreparation}{%
\subsection{Electrode Placement/Preparation}\label{electrode-placementpreparation}}
...
\subsection{AcqKnowledge}\label{acqknowledge}}
...
\section{Memory Intrusion/Movie Watching}\label{memory-intrusionmovie-watching}}
...
\section{Disc/Cond/Ext}\label{disccondext}}
...
\section{Hair Sample}\label{hair-sample}}

\hypertarget{set-up-hair-sample-station}{%
\subsection{Set Up Hair-Sample Station}\label{set-up-hair-sample-station}}
...
\subsection{Prior to Getting Hair Sample}\label{prior-to-getting-hair-sample}}
...
\subsection{Hair Sample Prep}\label{hair-sample-prep}}
...
\subsection{Hair Length}\label{hair-length}}
...
\section{Saliva Sample}\label{saliva-sample}}
...
\section{Memory Generalization}\label{memory-generalization}}
...
\subsection{Test Protocol}\label{test-protocol}}
...
\subsection{Physiology Marks}\label{physiology-marks}}
...
\section{Waist Measurement}\label{waist-measurement}}
...
\section{WASI \& WIAT}\label{wasi-wiat}}
...
\section{Blood Sample (DBS)}\label{blood-sample-dbs}}

\hypertarget{dbs-prep}{%
\subsection{DBS Prep}\label{dbs-prep}}
...
\subsection{VR Headset Setup}\label{vr-headset-setup}}
...
\subsection{Blood Sample Administration}\label{blood-sample-administration}}
...
\subsection{SOP for Fainting Emergency}\label{sop-for-fainting-emergency}}
...
\subsection{SOP for Biohazard Spill Emergency}\label{sop-for-biohazard-spill-emergency}}
...
\subsection{SOP for Incident Response and Reporting}\label{sop-for-incident-response-and-reporting}}
...
\section{Child Questionnaires}\label{child-questionnaires}}
...
\subsection{Children 8 \& Under}\label{children-8-under}}
...
\chapter{Parent Protocols}\label{parent-protocols}}

\hypertarget{ksads}{%
\section{KSADS}\label{ksads}}

\hypertarget{audio-recording}{%
\subsection{Audio Recording}\label{audio-recording}}
...
\subsection{Using the iPad for KSADS Summary Checklist}\label{using-the-ipad-for-ksads-summary-checklist}}
...
\section{Home Kit}\label{home-kit}}
...
\section{Participant Payment}\label{participant-payment}}

\textbf{Participant Reimbursement Signature}

\hypertarget{setting-up-the-ipad}{%
\subsection{Setting up the iPad}\label{setting-up-the-ipad}}
...
\subsection{To Obtain Signature}\label{to-obtain-signature}}
...
\subsection{To Save the Filled-Out Form}\label{to-save-the-filled-out-form}}
...
\chapter{Post-Lab Protocols}\label{post-lab-protocols}}

\hypertarget{stool-sample}{%
\section{Stool Sample}\label{stool-sample}}

\hypertarget{sample-quality}{%
\subsection{Sample Quality}\label{sample-quality}}
...
\subsection{Sample Transfer}\label{sample-transfer}}
...
\section{Data Review \& Audit}\label{data-review-audit}}

\hypertarget{follow-up-completed-by-scheduling-coordinator}{%
\subsection{Follow-Up (completed by Scheduling Coordinator)}\label{follow-up-completed-by-scheduling-coordinator}}
...
\subsection{Data Review (completed by Lab Manager \#1)}\label{data-review-completed-by-lab-manager-1}}
...
\subsection{Data Audit (completed by Lab Manager \#2)}\label{data-audit-completed-by-lab-manager-2}}
