...
Step 2:
- Researcher set timer for 1 minute (lower self volume).
...
\emph{Ok great! You can start chatting as soon as you hear Zoom say ``this meeting is now being recorded''}
...
If there are multiple participants in one session, refer back to top of protocols for MBB Online Session 1 from this point on. Repeat all protocols for each child, then proceed to Protocol - Home Session once the last child has finished their questionnaires.
