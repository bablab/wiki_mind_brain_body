...
\hypertarget{pre-virtual-session-checklist}{%
\subsection{Pre-Virtual Session Checklist}\label{pre-virtual-session-checklist}}
...
\hypertarget{virtual-session-setup---1-hour-prior}{%
\subsubsection{Virtual Session Setup - 1 Hour Prior}\label{virtual-session-setup---1-hour-prior}}
...
\hypertarget{virtual-session-checklist}{%
\subsection{Virtual Session Checklist}\label{virtual-session-checklist}}
...
\hypertarget{post-virtual-session-checklist}{%
\subsection{Post-Virtual Session Checklist}\label{post-virtual-session-checklist}}
