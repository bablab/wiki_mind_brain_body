...
{[}Then, confirm they are on the right page{]} \emph{You should be seeing a XYZ screen.}
...
\emph{OK! It is time to go back to our learning and memory section. Can you please log back onto the ``Gorilla'' website and complete the second part of this computer game?}

{[}Wait for child to log back on{]}

{[}Confirm that they are on the correct page{]} \emph{You should be seeing an XYZ screen.}
...
{[}Log into Gorilla and complete task{]}
