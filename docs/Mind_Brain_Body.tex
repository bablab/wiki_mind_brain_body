...
\hypertarget{initial-checklist-1}{%
\subsection{Initial Checklist}\label{initial-checklist-1}}
...
\item
  ...
  \tightlist
  \item
    Attach \href{https://ucla.app.box.com/file/665452959932}{Next Steps} and Zoom Instructions
  \end{itemize}
\end{itemize}
...
\hypertarget{pre-lab-session-checklist-1}{%
\subsection{Pre-Lab Session Checklist}\label{pre-lab-session-checklist-1}}
...
\hypertarget{lab-session-setup---1-hour-prior-1}{%
\subsubsection{Lab Session Setup - 1 Hour Prior}\label{lab-session-setup---1-hour-prior-1}}
...
\hypertarget{lab-session-checklist-1}{%
\subsection{Lab Session Checklist}\label{lab-session-checklist-1}}
...
\hypertarget{post-lab-session-checklist-1}{%
\subsection{Post-Lab Session Checklist}\label{post-lab-session-checklist-1}}
...
\hypertarget{final-checklist-1}{%
\subsection{Final Checklist}\label{final-checklist-1}}
...
\hypertarget{home-session-1}{%
\subsubsection{Home Session}\label{home-session-1}}
...
\hypertarget{childteen-parent-general-protocols-online}{%
\section{Child/Teen \& Parent General Protocols Online}\label{childteen-parent-general-protocols-online}}

\hypertarget{consent-assent-1}{%
\subsection{Consent \& Assent}\label{consent-assent-1}}
