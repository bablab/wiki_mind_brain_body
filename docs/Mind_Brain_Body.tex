...
\item
  ...
  \tightlist
  \item
    In notes section add the date and time of their scheduled session
  \end{itemize}
\item
...
\hypertarget{adding-to-participant-database}{%
\subsubsection{Adding to Participant Database}\label{adding-to-participant-database}}
...
\item
  ...
  \end{itemize}
\item
  Add the info provided on interest submission ( name, age, email, phone number)
\item
  For column labeled ``Added'':
...
\subsection{Making a Zoom Link}\label{making-a-zoom-link}}
...
\emph{I'll be there while you choose, but once your five minute discussion starts, I am going to turn off my camera and mute myself to be out of the recording, and I will also step out of the room and will not be listening in. I will come back in and let you know when the five minutes are all done!}

\emph{When you are ready, I will begin the recording and give you a minute or so to choose. Then, I will let you know when to start discussing for five minutes! Are you ready?}
...
Send participant \href{https://research.sc/participant/login/20451/publicid}{Gorilla link} and MBB number for login through the zoom chat.
