...
\item
  Open the R script for scoring cbcl using RStudio BABLAB/Studies/Mind\_Brain\_Body/Scripts/Wave\_1/Data\_scoring/Cbcl/cbcl\_scoring.Rmd
\end{enumerate}
...
\setcounter{enumi}{2}
\item
  Change the line with file name so it has the most updated date
...
\def\labelenumi{\arabic{enumi}.}
\item
  Make a copy of certificate template, type in participant name, and save as a pdf
