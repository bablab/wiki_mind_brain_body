...
\item
  Wave 2 Interview on REDCap home session checklist
\end{itemize}
...
\emph{For this activity, I am going to turn off my camera and mute myself to be out of the recording, and I will also step out of the room and will not be listening in. I will come back in and let you know when the six minutes are all done!}

\emph{When you are ready, I will begin the recording and give you a total of 6 minutes- 1 minute to choose, and five minutes to try to solve whatever problem or disagreements you chose! Are you ready?}
...
\tightlist
\item
  open up the Home Session Checklist to check for the script on the Wave 2 Interview
\item
  note parent comfortability with in-person sessions (as a projection for Wave 2)
\end{itemize}
...
\hypertarget{wave-2-interview}{%
\subsection{Wave 2 interview}\label{wave-2-interview}}
