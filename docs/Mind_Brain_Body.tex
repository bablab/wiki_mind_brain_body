...
\hypertarget{protocol---if-participant-had-feedback-to-give}{%
\subsection{Protocol - If participant had feedback to give}\label{protocol---if-participant-had-feedback-to-give}}
...
\item
  ...
  \item
    ...
    \end{itemize}
  \item
    \emph{MBBXXX WX- Session 2 Reminder 1 (\textbf{text message}) } - \textbf{4 days before second session}
...
\hypertarget{checklist---pre-session-1-1}{%
\subsection{Checklist - Pre-Session 1}\label{checklist---pre-session-1-1}}
...
\item
  Go to participant's Trello card from the data audit board and check if they were missing surveys from wave 1 and if any of their missing surveys are Recollected Surveys for wave 2.
...
\hypertarget{protocol---child-questionnaires-online-1}{%
\subsection{Protocol - Child Questionnaires Online}\label{protocol---child-questionnaires-online-1}}
...
{[} \textbf{If there is a child recollected survey that needs to be administered} {]}
...
\hypertarget{protocol---if-participant-had-feedback-to-give-1}{%
\subsection{Protocol - If participant had feedback to give}\label{protocol---if-participant-had-feedback-to-give-1}}
