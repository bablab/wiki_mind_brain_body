...
\emph{For the next part of this session, we will have you take some measurements from your child (height, weight, and waist). I will ask you to reach into your session package and pull out the ``Session Booklet'', a pencil, and the paper measuring tape.}
